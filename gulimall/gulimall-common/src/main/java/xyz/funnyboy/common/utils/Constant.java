...
import xyz.funnyboy.common.validator.group.AliyunGroup;
import xyz.funnyboy.common.validator.group.QcloudGroup;
import xyz.funnyboy.common.validator.group.QiniuGroup;
...
public class Constant
{
    ...
    public enum CloudService
    {
        ...
        public static CloudService getByValue(Integer value) {
            Optional<CloudService> first = Stream
                    .of(CloudService.values())
                    .filter(cs -> value.equals(cs.value))
                    .findFirst();
            if (!first.isPresent()) {
