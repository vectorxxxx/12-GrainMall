...
CREATE TABLE `oms_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1768883876895146012 DEFAULT CHARSET=utf8mb4 COMMENT='订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_order` VALUES (1768883876895146010,3,'202403201635447961770368616953311233',NULL,'2024-03-20 16:35:45',NULL,13998.0000,14014.0000,16.0000,0.0000,0.0000,0.0000,NULL,NULL,NULL,1,NULL,NULL,7,13998,13998,NULL,NULL,NULL,NULL,NULL,'徐芳艳','16636662810','514743','广东省','梅州市','汉族','南口镇车陂村国道26号',NULL,NULL,0,NULL,'2024-03-20 07:14:44','2024-03-20 16:35:45','2024-03-20 16:35:45','2024-03-20 16:35:45','2024-03-20 07:14:44'),(1768883876895146011,3,'202403201640537231770369912682868738',NULL,'2024-03-20 16:40:54',NULL,6999.0000,7015.0000,16.0000,0.0000,0.0000,0.0000,NULL,NULL,NULL,4,NULL,NULL,7,6999,6999,NULL,NULL,NULL,NULL,NULL,'徐芳艳','16636662810','514743','广东省','梅州市','汉族','南口镇车陂村国道26号',NULL,NULL,0,NULL,NULL,'2024-03-20 16:40:54','2024-03-20 16:40:54','2024-03-20 16:40:54','2024-03-20 16:40:54');
...
CREATE TABLE `oms_order_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1768883876924506142 DEFAULT CHARSET=utf8mb4 COMMENT='订单项信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_order_item` VALUES (1768883876924506140,1768883876895146010,'202403201635447961770368616953311233',4,'华为Mate 60 Pro 白沙银 12GB',NULL,'5',225,4,'华为Mate 60 Pro 白沙银 12GB','https://gulimall-vectorx.oss-cn-shanghai.aliyuncs.com/2024-02-02/494ac93f-9ed7-483a-8b40-f4338ceb9e74_%E7%99%BD%E6%B2%99%E9%93%B6.png',6999.0000,2,'机身颜色:白沙银;运行内存:12GB',0.0000,0.0000,0.0000,13998.0000,13998,13998),(1768883876924506141,1768883876895146011,'202403201640537231770369912682868738',4,'华为Mate 60 Pro 白沙银 12GB',NULL,'5',225,4,'华为Mate 60 Pro 白沙银 12GB','https://gulimall-vectorx.oss-cn-shanghai.aliyuncs.com/2024-02-02/494ac93f-9ed7-483a-8b40-f4338ceb9e74_%E7%99%BD%E6%B2%99%E9%93%B6.png',6999.0000,1,'机身颜色:白沙银;运行内存:12GB',0.0000,0.0000,0.0000,6999.0000,6999,6999);
...
INSERT INTO `oms_payment_info` VALUES (4,'202403201635447961770368616953311233',NULL,'2024032022001438290502525058',14014.0000,'华为Mate 60 Pro 白沙银 12GB','TRADE_SUCCESS','2024-03-20 16:36:10',NULL,NULL,'2024-03-20 16:36:10');
...
CREATE TABLE `pms_product_attr_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8mb4 COMMENT='spu属性值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_product_attr_value` VALUES (1,4,10,'上市日期','2023-08-29',0,1),(2,4,11,'机型','华为 Mate60 Pro',0,1),(3,4,12,'机身颜色','雅川青',0,1),(4,4,13,'机身重量','225g',0,1),(5,4,14,'机身尺寸','宽79mm；长163.65mm；厚8.1mm',0,1),(6,4,15,'存储卡','NM存储卡',0,1),(7,4,16,'运行内存','12GB',0,1),(8,4,17,'屏幕刷新率','120Hz',0,1),(9,4,18,'屏幕特色','昆仑玻璃',0,1),(10,4,19,'屏幕尺寸','6.82英寸',0,1),(11,4,20,'电池容量','5000mAh(typ)',0,1),(12,4,21,'无线充电','50W',0,1),(13,4,22,'充电功率','88W',0,1),(14,4,23,'系统','HarmonyOS',0,1),(15,4,24,'4G网络','未上市',0,0),(16,4,25,'卫星网络','支持',0,0),(17,4,26,'5G网络','未上市',0,0),(18,4,27,'双卡机类型','双卡双待',0,0),(19,4,28,'SIM卡数量','2个',0,0),(20,4,29,'生物识别','人脸识别；屏幕指纹',0,0),(21,4,30,'后摄2-超广角像素','1200万像素',0,0),(22,4,31,'后摄3-tele像素','4800万像素',0,0),(23,4,32,'前摄主像素','1300万像素',0,0),(24,4,33,'包装清单','\"手机（内置电池） x 1 华为SuperCharge充电器 X 1 USB Type-C 数据线 X 1 透明保护壳 x 1 快速指南 x 1 取卡针 x 1 保护膜（出厂贴在手机上） X 1 三包凭证 x 1 会员权益礼包 x 1\"',0,1),(169,10,10,'上市日期','2023-08-29',NULL,1),(170,10,11,'机型','华为 Mate60 Pro',NULL,1),(171,10,12,'机身颜色','乐臻版 雅丹黑',NULL,1),(172,10,13,'机身重量','225g',NULL,1),(173,10,14,'机身尺寸','宽79mm；长163.65mm；厚8.1mm',NULL,1),(174,10,15,'存储卡','NM存储卡',NULL,1),(175,10,16,'运行内存','12GB',NULL,1),(176,10,17,'屏幕刷新率','120Hz',NULL,1),(177,10,18,'屏幕特色','昆仑玻璃',NULL,1),(178,10,19,'屏幕尺寸','6.82英寸',NULL,1),(179,10,20,'电池容量','5000mAh(typ)',NULL,1),(180,10,21,'无线充电','50W',NULL,1),(181,10,22,'充电功率','88W',NULL,1),(182,10,23,'系统','HarmonyOS',NULL,1),(183,10,24,'4G网络','支持',NULL,1),(184,10,25,'卫星网络','支持',NULL,1),(185,10,26,'5G网络','支持',NULL,1),(186,10,27,'双卡机类型','双卡双待',NULL,1),(187,10,28,'SIM卡数量','2个',NULL,1),(188,10,29,'生物识别','人脸识别；屏幕指纹',NULL,1),(189,10,30,'后摄2-超广角像素','1200万像素',NULL,1),(190,10,31,'后摄3-tele像素','4800万像素',NULL,1),(191,10,32,'前摄主像素','1300万像素',NULL,1),(192,10,33,'包装清单','\"手机（内置电池） x 1 华为SuperCharge充电器 X 1 USB Type-C 数据线 X 1 透明保护壳 x 1 快速指南 x 1 取卡针 x 1 保护膜（出厂贴在手机上） X 1 三包凭证 x 1 会员权益礼包 x 1\"',NULL,1),(193,11,10,'上市日期','2023-08-29',0,1),(194,11,11,'机型','华为 Mate60 Pro',0,1),(195,11,12,'机身颜色','雅丹黑',0,1),(196,11,13,'机身重量','225g',0,1),(197,11,14,'机身尺寸','宽79mm；长163.65mm；厚8.1mm',0,1),(198,11,15,'存储卡','NM存储卡',0,1),(199,11,16,'运行内存','12GB',0,1),(200,11,17,'屏幕刷新率','120Hz',0,1),(201,11,18,'屏幕特色','昆仑玻璃',0,1),(202,11,19,'屏幕尺寸','6.82英寸',0,1),(203,11,20,'电池容量','5000mAh(typ)',0,1),(204,11,21,'无线充电','50W',0,0),(205,11,22,'充电功率','88W',0,0),(206,11,23,'系统','HarmonyOS',0,0),(207,11,24,'4G网络','未上市',0,0),(208,11,25,'卫星网络','支持',0,0),(209,11,26,'5G网络','未上市',0,0),(210,11,27,'双卡机类型','双卡双待',0,0),(211,11,28,'SIM卡数量','2个',0,0),(212,11,29,'生物识别','人脸识别；屏幕指纹',0,0),(213,11,30,'后摄2-超广角像素','1200万像素',0,0),(214,11,31,'后摄3-tele像素','4800万像素',0,0),(215,11,32,'前摄主像素','1300万像素',0,0),(216,11,33,'包装清单','\"手机（内置电池） x 1 华为SuperCharge充电器 X 1 USB Type-C 数据线 X 1 透明保护壳 x 1 快速指南 x 1 取卡针 x 1 保护膜（出厂贴在手机上） X 1 三包凭证 x 1 会员权益礼包 x 1\"',0,1);
...
CREATE TABLE `pms_sku_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='sku图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_sku_info` (
  ...
  PRIMARY KEY (`sku_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COMMENT='sku信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_sku_sale_attr_value` (
  ...
  `attr_sort` int(11) DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='sku销售属性&值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_sku_sale_attr_value` VALUES (1,1,12,'机身颜色','雅川青',0),(2,1,16,'运行内存','12GB',0),(3,2,12,'机身颜色','雅丹黑',0),(4,2,16,'运行内存','12GB',0),(5,3,12,'机身颜色','南糯紫',0),(6,3,16,'运行内存','12GB',0),(7,4,12,'机身颜色','白沙银',0),(8,4,16,'运行内存','12GB',0),(19,10,12,'机身颜色','乐臻版 雅丹黑',0),(20,10,16,'运行内存','12GB',0),(21,11,12,'机身颜色','雅丹黑',0),(22,11,16,'运行内存','12GB',0),(23,12,12,'机身颜色','乐臻版 雅丹黑',0),(24,12,16,'运行内存','12GB',0);
...
CREATE TABLE `pms_spu_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='spu图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_spu_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='spu信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_spu_info` VALUES (4,'华为Mate 60 Pro','华为（HUAWEI）旗舰手机 Mate 60 Pro 12GB+512GB 雅川青',225,5,0.2250,1,'2024-02-02 20:16:43','2024-02-21 15:09:44'),(10,'华为（HUAWEI）Mate 60 Pro 乐臻版','华为（HUAWEI）Mate 60 Pro 乐臻版【Mate 60 Pro 12GB+512GB 雅丹黑&Freebuds 5 至臻版 冰霜银】旗舰手机',225,5,0.2250,1,'2024-02-02 20:48:09','2024-02-21 15:13:19'),(11,'华为（HUAWEI）旗舰手机 Mate 60 Pro 12GB+512GB 雅丹黑','华为（HUAWEI）旗舰手机 Mate 60 Pro 12GB+512GB 雅丹黑',225,5,0.2250,0,'2024-02-03 16:35:10','2024-02-03 16:35:10');
...
INSERT INTO `sms_member_price` VALUES (1,10,2,'钻石会员',7849.0000,1),(2,11,2,'钻石会员',6949.0000,1);
...
INSERT INTO `sms_seckill_promotion` VALUES (1,'畅享华为','2024-03-22 22:01:43','2024-03-24 22:01:43',1,'2024-03-22 22:01:43',1);
...
INSERT INTO `sms_seckill_session` VALUES (1,'二〇二四年三月二十二日农历二月十三','2024-03-22 12:20:51','2024-03-23 02:17:51',1,'2024-03-22 22:17:51');
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='秒杀活动商品关联';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_seckill_sku_relation` VALUES (1,1,1,4,4999,10,1,1);
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='商品满减信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_sku_full_reduction` VALUES (1,10,1000.0000,10.0000,0),(2,11,10000.0000,100.0000,0);
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='商品阶梯价格';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_sku_ladder` VALUES (1,10,10,0.98,NULL,1),(2,11,10,0.98,NULL,0);
...
INSERT INTO `sms_spu_bounds` VALUES (1,4,100.0000,100.0000,NULL),(2,5,100.0000,100.0000,NULL),(3,6,100.0000,100.0000,NULL),(4,7,100.0000,100.0000,NULL),(5,8,100.0000,100.0000,NULL),(6,9,100.0000,100.0000,NULL),(7,10,100.0000,100.0000,NULL),(8,11,100.0000,100.0000,NULL);
...
CREATE TABLE `ums_member` (
  ...
  `social_uid` varchar(255) DEFAULT NULL COMMENT '社交账号ID',
  `access_token` varchar(255) DEFAULT NULL COMMENT '社交账号Token',
  `expires_in` varchar(255) DEFAULT NULL COMMENT '社交账号Token过期时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='会员';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_member` VALUES (1,1,'test01','$2a$10$noyFpi6OgXICjPgyOG1y8elmcWX/59l7HDImDI/UqpvmWKxmOgge.','test01','18913212404',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,'2024-03-06 21:40:48',NULL,NULL,NULL),(2,1,'test02','$2a$10$axh1HoZZ4yV7W9CKYIwk3./QbdArAUW2bksU6cIJIYr.MjnDCICbO','test02','19941918997',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,'2024-03-06 21:58:40',NULL,NULL,NULL),(3,NULL,NULL,NULL,'VectorX',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2024-03-07 14:43:43','8991049','9bfbfe22ab400f2f9dd41036094a7c32','86400');
...
INSERT INTO `ums_member_receive_address` VALUES (1,3,'徐芳艳','16636662810','514743','广东省','梅州市','汉族','南口镇车陂村国道26号',NULL,1),(2,3,'姚禹辰','17251516679','621001','四川省','绵阳市','汉族','经开区绵州大道中段199号绵阳经开万达广场21栋11层22号',NULL,0);
...
CREATE TABLE `wms_ware_order_task` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COMMENT='库存工作单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wms_ware_order_task` VALUES (25,NULL,'202403201635447961770368616953311233',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(26,NULL,'202403201640537231770369912682868738',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `wms_ware_order_task_detail` VALUES (22,4,'华为Mate 60 Pro 白沙银 12GB',2,25,2,1),(23,4,'华为Mate 60 Pro 白沙银 12GB',1,26,2,2);
...
INSERT INTO `wms_ware_sku` VALUES (1,10,1,100,'华为（HUAWEI）Mate 60 Pro 乐臻版 乐臻版 雅丹黑 12GB',0),(2,4,2,50,'华为Mate 60 Pro 白沙银 12GB',2);
...
-- Dump completed on 2024-03-24 12:52:26
