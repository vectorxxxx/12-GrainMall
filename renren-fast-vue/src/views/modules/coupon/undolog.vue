  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="undo_log context,such as serialization">
      </el-table-column>
      <el-table-column
        prop="rollbackInfo"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="0:normal status,1:defense status">
      </el-table-column>
      <el-table-column
        prop="logCreated"
        header-align="center"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.branchId)">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.branchId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
